...
<img src="./logo.png" width="160" style="display:block; margin:0 auto;" />
...
The Elechukwu team makes all reasonable efforts to identify as many vulnerabilities as possible within the given time frame but assumes no responsibility for undiscovered issues.

A security audit is **not** an endorsement of the underlying business or product.  
The review was time-boxed and focused solely on the **security aspects** of the Solidity implementation.
...
Severity ratings follow the  
**CodeHawks Severity Matrix**:  
